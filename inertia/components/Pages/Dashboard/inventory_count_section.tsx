      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6 xl:grid-cols-3 2xl:gap-7.5">
        <div className="rounded-sm border border-stroke bg-white p-4 shadow-default dark:border-strokedark dark:bg-boxdark md:p-6 xl:p-7.5">
          <div className="flex items-end justify-between">
            <div>
              <h3 className="mb-4 text-title-lg font-bold text-black dark:text-white">197</h3>
            ...
            <div x-data="{percent : 60}">
              <svg className="h-17.5 w-17.5 -rotate-90 transform">
                ...
                <circle
                  ...
                  stroke-dashoffset={30 * 2 * Math.PI - (60 / 100) * 30 * 2 * Math.PI}
                  stroke-linecap=""
                  stroke="currentColor"
                  fill="transparent"
                  r="30"
        ...
        <div className="rounded-sm border border-stroke bg-white p-4 shadow-default dark:border-strokedark dark:bg-boxdark md:p-6 xl:p-7.5">
          <div className="flex items-end justify-between">
            <div>
              <h3 className="mb-4 text-title-lg font-bold text-black dark:text-white">745</h3>
        ...
        <div className="rounded-sm border border-stroke bg-white p-4 shadow-default dark:border-strokedark dark:bg-boxdark md:p-6 xl:p-7.5">
          <div className="flex items-end justify-between">
            <div>
              <h3 className="mb-4 text-title-lg font-bold text-black dark:text-white">512</h3>
            ...
            <div x-data="{percent : 70}">
              <svg className="h-17.5 w-17.5 -rotate-90 transform">
                ...
                <circle
                  ...
                  stroke-width="10"
                  stroke-dasharray={30 * 2 * Math.PI}
                  stroke-dashoffset={30 * 2 * Math.PI - (70 / 100) * 30 * 2 * Math.PI}
                  stroke-linecap=""
                  stroke="currentColor"
                  fill="transparent"
                  r="30"
